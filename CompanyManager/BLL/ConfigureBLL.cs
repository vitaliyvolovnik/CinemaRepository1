...
namespace BLL
{
    public static class ConfigureBLL
    {
        ...
        {
            collection.AddDbContext<CinemaContext>(o=>o.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=CinemaDbb1;Integrated Security=True;Connect Timeout=30;"));
